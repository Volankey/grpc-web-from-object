...
function setRequestBody(ReqType, data) {
  ...
  Object.entries(data).forEach(([key, value]) => {
    ...
    let finalVal = null;
    const valueTypeCtor =
      (_a = reqTypeInstance[setMethodName].getValueType) == null
        ? void 0
        : _a.call(reqTypeInstance);
    if (setMethodCall) {
...
function createInvoker(client, initConfig, invokerOptions) {
  ...
  const invoke = function invoke2(method, data, metadata, options) {
    ...
    console.log(
      "\u{1F680} ~ file: createGrpcWebInvoker.ts ~ line 152 ~ requestBody",
      requestBody
    );
    const tmpMetadata = (0, import_lodash_es.merge)(
      metadata,
      config.globalMeta
    );
    let reqInstance = null;
    if (
      (options == null ? void 0 : options.mock) ||
      (invokerOptions == null ? void 0 : invokerOptions.mock)
    ) {
      if (
        (invokerOptions == null ? void 0 : invokerOptions.mockServer) === void 0
      ) {
    ...
    return new Promise((resolve, reject) => {
      reqInstance = client[method](requestBody, tmpMetadata, (err, resp) => {
        var _a;
        if (err) {
          (_a = config == null ? void 0 : config.errorHandler) == null
            ? void 0
            : _a.call(config, err);
          reject(err);
        } else {
